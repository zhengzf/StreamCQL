...
public interface CQLParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CQLParser#constList}.
	 * @param ctx the parse tree
	 */
	void enterConstList(@NotNull CQLParser.ConstListContext ctx);
	/**
	 * Exit a parse tree produced by {@link CQLParser#constList}.
	 * @param ctx the parse tree
	 */
	void exitConstList(@NotNull CQLParser.ConstListContext ctx);
